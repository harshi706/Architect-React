  ...
  return (
    <div>
      ...
      <div className="mt-20 sm:ml-[50px] ml-[20px] sm:mr-[50px] mr-[20px] p-10 space-y-10">
        ...
        <section>
          <div className="image-text">
            ...
            <div>
              <div>
                <img
                  src="https://www.ikea.com/images/47/a5/47a5903aaf7d1c233ef9d16c3c7aa640.png?f=l"
                  alt=""
                />
              </div>
            </div>
        ...
        {/* AYATRIO stores and collection point section starts */}
        <section>
          ...
          <div className="image-text">
            <div>
              <div>
                <img
                  src="https://www.ikea.com/images/bb/99/bb993818c7cbcae700212d260d717bbe.png?f=l"
                  alt=""
                />
              </div>
            </div>
        ...
        {/* AYATRIO stores and collection point section ends */}
        {/* Know your store section starts */}
        <section>
          <div>
            <div>
        ...
        {/* Know your store section ends */}
        <hr />
        {/* AYATRIO com section starts */}
        <section>
          <div className="space-y-5">
        ...
        {/* AYATRIO for business section starts */}
        <section>
          <div>
            <div>
              <h2 className="font-bold text-xl mb-10">AYATRIO for Business</h2>
            </div>
            <div className="image-text">
              <div>
                <img
                  src="https://www.ikea.com/images/b0/3d/b03d90c888a8c109900cebdffc4646c2.png?f=l"
                  alt=""
                />
              </div>
              <div>
        ...
        {/* AYATRIO for business section ends */}
        <section>
