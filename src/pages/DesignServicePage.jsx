        ...
        <div className="mt-20 sm:ml-[50px] ml-[20px] sm:mr-[50px] mr-[20px] p-10 space-y-10">
          ...
          <section>
            <div className="flex flex-col w-full space-y-4">
              ...
              <div className="flex w-full space-x-7 justify-center">
                <div className="flex flex-col space-y-12 w-1/4 border border-t-4 border-t-black p-4 shadow-2xl">
          ...
          <section>
            <div className="flex w-full">
              <div className="w-1/2 bg-lime-100 py-36 px-28">
                <div className="flex flex-col space-y-3">
                  <div>
                    <p className="font-semibold text-lg">
              ...
              <div className="w-1/2 py-16 px-48">
          ...
          <section>
            <div className="flex w-full flex-col space-x-4 items-center">
              <div>
