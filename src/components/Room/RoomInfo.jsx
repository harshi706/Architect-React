...
const RoomInfo = () => {
  return (
    <div className="flex my-6 sm:ml-1" style={{ width: "100%" }}>
      <div className="mr-4 sm:w-[60%] sm:mt-0 mt-[-20rem]">
        ...
        <div>
          <div>
            <div className="border border-gray-300 sm:h-20 h-64 sm:w-[46vw] w-[100%] rounded-lg flex sm:flex-row flex-col pt-4 sm:pb-3 sm:pl-6">
              <svg
                viewBox="0 0 20 32"
                fill="none"
              ...
              <div
                className="pl-4 pr-5 font-medium"
