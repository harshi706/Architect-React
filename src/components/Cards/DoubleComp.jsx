...
const DoubleComp = () => {
  return (
    // sm:h-[35rem] 
    <div className=" text-center py-20 grid sm:grid-cols-2 grid-cols-1 sm:w-auto w-[100%] gap-4 sm:px-[50px]">
      <div className="col-span-1 ml-0 sm:pr-8 pr-0 bg-zinc-100 text-white overflow-hidden">
        <div>
